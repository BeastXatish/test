...
import getOpps from '@salesforce/apex/sampleCompo.getOpps';
...
export default class DataTableWithSorting extends LightningElement {
    @track value;
    @track error;
    @track data;
    ...
    previousHandler() {
        ...
        if (this.page > 1) {
          ...
          for(var i=0; i<this.allSelectedRows.length;i++){
            ...
            console.log('Selected Row',this.selectedIds);
          }
